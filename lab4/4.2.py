...
def bear(color, x, y, m):
    ...
    Рисует медведя
    color - цвет
    x - координата опорной точки медведя по горизонтали (чуть выше центра его брюха, на уровне верхней лапы)
    y - координата опорной точки медведя по вертикали
...
def fish(x, y, m):
    '''
    Рисует рыбу
    x - координата центра рыбы по горизонтали
    y - координата центра рыбы по вертикали
    m - масштаб
    '''
    color_1 = (191, 203, 200)
    color_2 = (221, 166, 166)
...
def bearandfish(x, y, m):
    '''
    Создание шаблона из медведя, 5 рыбок и лунки
    x - координата по горизонтали опорной точки (чуть выше центра брюха медведя, на уровне верхней лапы)
    y - координата по вертикали опорной точки
    m - масштаб
    '''
